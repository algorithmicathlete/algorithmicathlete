...
def create_court(ax, color):
    ...
    ax.plot([220, 220], [0, 140], linewidth=2, color=color)
    ax.add_artist(mpl.patches.Arc((0, 52.5), 237.5*2, 237.5*2, theta1=22, theta2=158, facecolor='none', edgecolor=color, lw=2))
    ...
    ax.add_artist(mpl.patches.Circle((0, 52.5), 7.5, facecolor='none', edgecolor=color, lw=2))
