...
def scrape_actual_year(year):
    ...
    for i, row in enumerate(table.find_all("tr")):
        ...
        if pre:
            top_players[year][name]["end pos ovr"] = i+1
            top_players[year][name]["end pos pos"] = pos_rank
